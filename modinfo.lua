...
dst_compatible = true
server_filter_tags = {"Enhanced Houndius Shootius"}
...
configuration_options =
{
    ...
    {
        name = "eyeturret_protect",
        label = "Prevent Attacking Each Other",
        hover = "Prevent Houndius Shootius From Attacking Each Other",
        options =   {
